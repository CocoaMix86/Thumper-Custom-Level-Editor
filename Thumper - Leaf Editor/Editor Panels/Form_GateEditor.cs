...
namespace Thumper_Custom_Level_Editor.Editor_Panels
{
    public partial class Form_GateEditor : WeifenLuo.WinFormsUI.Docking.DockContent
    {
        ...
        private void gatesaveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (_loadedgate == null) {
                _mainform.gatesaveAsToolStripMenuItem.PerformClick();
                return;
            }
            else
                WriteGate();
        ...
        private void btnGatePanelNew_Click(object sender, EventArgs e) => _mainform.gatenewToolStripMenuItem.PerformClick();
        ...
        public void LoadGate(dynamic _load, string filepath)
        {
            ...
            if (panelGate.Visible == false)
                _mainform.gateEditorToolStripMenuItem.PerformClick();
