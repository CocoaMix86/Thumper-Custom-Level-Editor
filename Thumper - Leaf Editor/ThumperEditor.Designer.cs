namespace Thumper_Custom_Level_Editor
{
	partial class FormLeafEditor
	{
		...
		private void InitializeComponent()
		{
            ...
            this.toolTip1.SetToolTip(this.dropLeafInterp, "Interpolation type between beat values. Higher interpolation = smoother transitions/curves,\nbut higher intensity calculation.Can decrease FPS.\nTHIS AFFECTS IN - GAME ONLY.NOT THIS EDITOR'S INTERPOLATION CALC.");
