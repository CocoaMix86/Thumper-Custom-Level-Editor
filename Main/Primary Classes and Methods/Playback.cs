    ...
    public static class Playback
    {
        ...
        public static void CreatePlaybackFromLvl(LvlProperties Lvl, int BeatStop = -1, int _BeatOffset = 0)
        {
            ...
            foreach (LvlLeafData leaf in Lvl.Leafs) {
                SimpleLeafProperties _leafload = UtilCreate.SimpleLeaf(UtilFile.LoadFileLock(ProjectExplorer.TryGetFile(leaf.Leaf, out ProjectItem _file) ? _file.FilePath : null), _file.FilePath);
        ...
        public static void CreatePlaybackFromGate(GateProperties Gate, int BeatStop = -1, int _BeatOffset = 0)
        {
            ...
            EditorLvl lvlpre = (EditorLvl)TCLE.OpenFile(ProjectExplorer.TryGetFile(Gate.prelvl, out ProjectItem _lvlpre) ? _lvlpre.FilePath : null, false, true);
            if (lvlpre != null) {
            ...
            //create playback of the pre lvl
            EditorLvl lvlpost = (EditorLvl)TCLE.OpenFile(ProjectExplorer.TryGetFile(Gate.postlvl, out ProjectItem _lvlpost) ? _lvlpost.FilePath : null, false, true);
            if (lvlpost != null) {
            ...
            foreach (GateLvlData lvl in Gate.GateLvls) {
                EditorLvl lvltoplay = (EditorLvl)TCLE.OpenFile(ProjectExplorer.TryGetFile(lvl.LvlName, out ProjectItem _lvl) ? _lvl.FilePath : null, false, true);
        ...
        public static void CreatePlaybackFromMaster(MasterProperties Master, int BeatStop = -1, int _BeatOffset = 0)
        {
            ...
            EditorLvl lvlcheckpoint = (EditorLvl)TCLE.OpenFile(ProjectExplorer.TryGetFile(Master.checkpointlvl, out ProjectItem _check) ? _check.FilePath : null, false, true);
            //create playback of the intro lvl
            EditorLvl lvlintro = (EditorLvl)TCLE.OpenFile(ProjectExplorer.TryGetFile(Master.introlvl, out ProjectItem _lvlintro) ? _lvlintro.FilePath : null, false, true);
            if (lvlintro != null) {
            ...
            foreach (MasterLvlData lvl in Master.MasterLvls) {
                ...
                //load rest lvl first
                EditorLvl lvlrest = (EditorLvl)TCLE.OpenFile(ProjectExplorer.TryGetFile(lvl.RestLvl, out ProjectItem _rest) ? _rest.FilePath : null, false, true);
                if (lvlrest != null) {
                ...
                //load main lvl
                if (lvl.Type == "gate") {
                    EditorGate gatetoplay = (EditorGate)TCLE.OpenFile(ProjectExplorer.TryGetFile(lvl.WholeName, out ProjectItem _gate) ? _gate.FilePath : null, false, true);
                    ...
                    EditorLvl lvltoplay = (EditorLvl)TCLE.OpenFile(ProjectExplorer.TryGetFile(lvl.WholeName, out ProjectItem _lvl) ? _lvl.FilePath : null, false, true);
                    Playback.CreatePlaybackFromLvl(lvltoplay.LvlProperties, lvltoplay.LvlProperties.Beats, beatoffset);
                    if (beatoffset == 0)
